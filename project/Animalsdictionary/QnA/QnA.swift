...
var Qnum: Int = 0
var Anum: Int = 0
var question: [String] = ["Q1. 식비나 병원비 등의 지출을 감당할 충분한 경제적 여유가 있다.", "Q2. 반려동물과 산책을 하거나 함께할 충분한 시간적 여유가 없다.", "Q3. 반려동물은 소음 및 냄새의 원인이 된다는 것을 인지하고 있다.", "Q4. 단순히 귀여울 것 같거나 잠깐의 외로움 때문에 가벼운 마음으로 동물을 입양하려고 한다.", "Q5. 동반자가 없거나, 모든 동반자와 반려동물 입양에 대하여 합의했다."]
