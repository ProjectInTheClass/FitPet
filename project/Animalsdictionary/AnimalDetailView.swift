        ...
        ScrollView {
            VStack(spacing:20){
                ...
                VStack(alignment:.leading, spacing:20){
                    ...
                    Text(" \(animal.title)에 대해 더알아보기".uppercased())
                        .fontWeight(.bold)
