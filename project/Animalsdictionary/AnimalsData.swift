...
var animalsData: [Animal] = [
    ...
    Animal(
        ...
        species: ["샴", "페르시안", "메인쿤", "벵갈", "스핑크스"],
        speciesImage: ["강아지", "강아지", "강아지", "강아지","강아지"]
    ),
    ...
    Animal(
        ...
        species: ["이구아나", "카멜레온", "레오파드게코", "크레스티드게코"],
    ...
    Animal(
        ...
        species: ["카나리아", "앵무새", "십자매"],
        speciesImage: ["강아지", "강아지", "강아지"]
    ),
    Animal(
        title: "토끼",
        headline: "식육목 고양이과의 포유류.\n생물종 분류로는 고양이과에 속하며 사자, 표범, 재규어와 근연속",
    ...
    Animal(
        ...
        species: ["시리아 햄스터", "드워프 햄스터", "차이니즈 햄스터"],
        speciesImage: ["강아지", "강아지", "강아지"]
    ),
                 ]
/*
