...
var animalsData: [Animal] = [
    ...
    Animal(
        ...
        recommandtype: "파충류",
        species: ["볼 파이톤", "콘스네이크", "킹 스네이크", "밀크 스네이크", "보아뱀"],
        speciesImage: ["볼 파이톤", "콘스네이크", "킹 스네이크", "밀크 스네이크", "보아뱀"]
    ),
    ...
    Animal(
        ...
        recommandtype: "포유류",
        species: ["골든 햄스터", "드워프 햄스터", "차이니즈 햄스터","테디베어 햄스터"],
        speciesImage: ["골든 햄스터", "드워프 햄스터", "차이니즈 햄스터", "테디베어 햄스터"]
    ),
    Animal(
        title: "고슴도치",
        headline: "식육목 고양이과의 포유류.\n생물종 분류로는 고양이과에 속하며 사자, 표범, 재규어와 근연속",
